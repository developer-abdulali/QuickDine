                        ...
                        <div key={
                            ...
                            <div className="space-y-1.5 flex-1">
                                <div className="flex items-center gap-3">
                                    ...
                                    <span title="Booking ID" className="text-[9px] text-black/50 border border-outline-variant/30 px-1.5 py-0.5">
                                        {
                                        b.bookingId
                                    } </span>
                                    <span title="Restaurant Name" className="text-[9px] text-black/50 border border-outline-variant/30 px-1.5 py-0.5">
                                        {
                                        b.restaurant.name
                                    } </span>
                                </div>
                            ...
                            <div className="flex flex-wrap items-center gap-3 w-full md:w-auto justify-end">
                                <span className={
                                    `text-[9px] font-medium tracking-wider uppercase px-2 py-0.5 rounded-sm ${
