            ...
            <form onSubmit={onSubmit}
                ...
                <div className="space-y-1">
                    ...
                    <textarea value={specialRequests}
                        ...
                        className="w-full bg-surface-container-low/20 border border-outline-variant/40 rounded-md p-3 text-xs focus:border-secondary focus:outline-none"></textarea>
                </div>
